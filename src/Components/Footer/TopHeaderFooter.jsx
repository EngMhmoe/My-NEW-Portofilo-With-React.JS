...
// Component
// ============================================================
export default function TopHeaderFooter() {
  // ============================================================
  // Dark Mode
  // ============================================================
  ...
  const connectTextStyle = darkMode ? "text-red-500" : "text-[#fd8ea6]";
  ...
  return (
    <div className={containerStyle}>
      ...
      >
        <span>
          {t("let's")} <span className={connectTextStyle}>{t("connect")}</span>{" "}
      ...
      {/* ======================================================
          Social Media
      ====================================================== */}
      <div dir="ltr" className="social-container">
        {/* ====================================================
            Facebook
        ==================================================== */}
        <motion.a
        ...
        <motion.a
          ...
          className={`social-card ${
            darkMode ? "card-whatsapp-dark" : "card-whatsapp"
          }`}
          // ==================================================
          // Refresh Animation Only
          // ==================================================
        ...
        <motion.a
          ...
          rel="noopener noreferrer"
          aria-label="GitHub"
          className="social-card card-github"
          // ==================================================
          // Refresh Animation Only
          // ==================================================
          initial={{
